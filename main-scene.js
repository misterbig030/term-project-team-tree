...
class Assignment_Three_Scene extends Scene_Component {
    ...
    draw_cloud(graphics_state, t){
        ...
        cloud_transform = cloud_transform.times(Mat4.translation([-18*t, 23, -3]));
    ...
    draw_apple(graphics_state, t)
    {
        let apple_transform = Mat4.identity();
        apple_transform = apple_transform.times(Mat4.translation([5, 17/t, 0]));
        let app = apple_transform.times(Mat4.scale([1, 1, 1]));
    ...
    display(graphics_state) {
        ...
        else
        {
            ...
            cloud_transform = cloud_transform.times(Mat4.translation([0, 23, -3]));
            let cloud1 = cloud_transform.times(Mat4.scale([10, 1, 1]));
            this.shapes.cloud.draw(graphics_state, cloud1, this.materials.cloud);
            ...
            let apple_transform = Mat4.identity();
            apple_transform = apple_transform.times(Mat4.translation([5, 17, 0]));
            let app = apple_transform.times(Mat4.scale([1, 1, 1]));
            ...
            if (this.apple_t > 1 && this.apple_t < 10){
                this.draw_apple(graphics_state,this.apple_t);
            }
